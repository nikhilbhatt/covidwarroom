 ...
 */
define ('K_BLANK_IMAGE', dirname(dirname(__FILE__)).'/images/uklogo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Uttarakhand State Control Room');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Uttarakhand State Control Room');
